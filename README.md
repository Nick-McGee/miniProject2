...
- Download the `src` direcotry, set the directory to the directory containg `src` directory, and then run this command: `javac src/main/*.java && java -cp src/ main.Main`
